...
def store_team(team: Team) -> None:
    ...
    with open(FILE_PATH, "r") as team_file:
        file_content: dict[str, dict[str, all]] = dict(json.load(team_file))
...
def load_teams() -> list[Team]:
    with open(FILE_PATH, "r") as team_file:
        file_content: dict[str, dict[str, all]] = dict(json.load(player_file))
...
def update_team(uuid: str, key: str, value: all) -> None:
    with open(FILE_PATH, "r") as team_file:
        file_content: dict[str, dict[str, all]] = dict(json.load(team_file))
