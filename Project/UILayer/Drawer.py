...
class Drawer():
    ...
    def clear(self) -> None:
        ...
        :returns:
            Nothing
        """
        # Use the os import to check what system the user uses
        # and run the appropriate clear command
...
{self.banner_border}{self.line}{self.reset}"""
    ...
    def table(self,
              menu: str,
              user_path: list[MenuOptions] | None = None,
        ...
        :param options:
            Dictionary of all the input options that the user has
            and what action they correspond to
        ...
        # Create an empty string that will position
        # the table a little from the top of the string
        ...
        if user_path and user_path is not None:
            path += user_path[0]
        ...
        # along with a line to seperate the information
        table += f"{menu: ^80}" + "\n"
        table += self.line

        # If there are any previous inputs saved
        # they are added to the table along with a line
        ...
        # with a space between the key and value in the dictionary
    ...
    def start_table(self,
                    menu: str,
                    user_path: list[MenuOptions] | None = None,
                    options: dict[str, str] | None = None) -> str:
        ...
        # that will hold the entirety of the table as a string
        table: str = ""
        ...
        # Options are colored green
        # and added to the table with a space between
    ...
    def save_input(self, user_input: str) -> None:
        ...
        :param user_input:
            String of the info that is to be printed on top of the table
            along with the user input ex. (Name: USERINPUT)
        :type user_input: str
        ...
        # Saves the info and user input in a string
    ...
    def clear_saved_data(self) -> None:
        ...
        # so that they dont print in other tables
